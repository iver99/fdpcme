...
package oracle.sysman.emaas.platform.uifwk.ui.webutils.wls.lifecycle;
...
{
	public static final String APPLICATION_LOGGER_SUBSYSTEM = "oracle.sysman.emaas.platform.uifwk.ui";
	...
	{
		LOGGER.notice("Post-starting registered OMC UI Framework services");
		try {
	...
	{
		LOGGER.notice("Post-stopping registered OMC UI Framework services");
		try {
	...
	{
		LOGGER.debug("Pre-starting registered OMC UI Framework services");
		try {
	...
	{
		LOGGER.debug("Pre-stopping registered OMC UI Framework services");
		try {
