    ...
    function(ko, $, dfu,km) {
        ...
        $(document).ready(function () {
            ...
            new Builder.DashboardDataSource().loadDashboardData(dsbId, function (kodb) {
                dashboard = kodb;
                var isUderSet = ko.unwrap(dashboard.type) === "SET" ? true : false;;
                ...
                Builder.eagerLoadDahshboardTilesAtPageLoad(dfu, ko, normalMode, tabletMode, mode, isUderSet, timeSelectorModel, targets);
