...
define([
    ...
    function(oj, ko, $)
    {
        function VisualizationModel() {
            ...
            self.params.chartType=chartType;
            ...
            function refresh() {
                if(self.chartTypeValue().length<=0)
                    self.chartTypeValue([self.params.chartType]);
                
                var size = 50;
                if (self.params.endTime !== null) {
                    var diff = self.params.endTime.getTime()-self.params.startTime.getTime();
                ...
                var tempDate = self.params.startTime;
                var series=[];
                var groups=[];
                var seriesItems = [];
                for (i = 0; i < size; i++) 
