...
public class EntitySelectorUtil
{
	 ...
	 * @return
	 */
	public static void removePill(WebDriver driver, int index)
	{
		IEntitySelectorUtil esu = new UtilLoader<IEntitySelectorUtil>().loadUtil(driver, IEntitySelectorUtil.class);
	 ...
	 * @return
	 */
	public static void selectCompositeEntity(WebDriver driver, String text, String type)
	{
		IEntitySelectorUtil esu = new UtilLoader<IEntitySelectorUtil>().loadUtil(driver, IEntitySelectorUtil.class);
	 ...
	 * @return
	 */
	public static void selectEntity(WebDriver driver, String text, String type)
	{
		IEntitySelectorUtil esu = new UtilLoader<IEntitySelectorUtil>().loadUtil(driver, IEntitySelectorUtil.class);
