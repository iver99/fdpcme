...
public class WelcomeUtil
{
	 ...
	 * 
	 * @param serviceName
	 * 		APM | LA | ITA | infraMonitoring | securityAnalytics | dashboards | dataExplorers | getStarted | videos | serviceOfferings
	 * @return
	 */
	 ...
	 * 
	 * @param serviceName
	 * 		APM | LA | ITA | infraMonitoring | securityAnalytics | dashboards | dataExplorers
	 * @return
	 */
	...
	public static boolean isServiceExistedInWelcome(WebDriver driver, String serviceName) throws Exception
	{
		...
		Validator.fromValidValues("serviceName", serviceName, SERVICE_NAME_APM, SERVICE_NAME_LA, SERVICE_NAME_ITA,
				SERVICE_NAME_INFRA_MONITORING, SERVICE_NAME_SECURITY_ANALYTICS,  SERVICE_NAME_DASHBOARDS, SERVICE_NAME_DATA_EXPLORERS);
