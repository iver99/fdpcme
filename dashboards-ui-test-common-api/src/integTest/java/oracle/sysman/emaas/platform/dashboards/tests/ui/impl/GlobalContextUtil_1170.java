...
public class GlobalContextUtil_1170 extends GlobalContextUtil_1160
{
	...
	public static final String GLBCTX_CTXSEL_TEXT = ".pillTextClassGC.filterpill_text";//"//span[text()='Start typing entity name(s)...']"; 
	/* (non-Javadoc)
	...
	public boolean isGlobalContextExisted(WebDriver driver)
	{
		...
		if (driver.isDisplayed(GLBCTXTID)) {
			...
			if (driver.isDisplayed(GLBCTX_TOPBTN) && driver.isDisplayed("css="+GLBCTX_CTXSEL_TEXT)) {
	...
	{
		return driver.getText("css="+GLBCTX_CTXSEL_TEXT);
	}
}
