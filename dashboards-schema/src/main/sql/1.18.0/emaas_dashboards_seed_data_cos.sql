...
BEGIN
    ...
    LOOP
     ...
     END IF;
        ...
        SELECT COUNT(1) INTO V_COUNT FROM EMS_DASHBOARD_TILE
            WHERE TENANT_ID = V_TENANT_ID AND TILE_ID = 127 AND (WIDTH <> 12 OR HEIGHT <> 2);
        IF V_COUNT < 1 THEN
            DBMS_OUTPUT.PUT_LINE('TILE Overview NOT USED NO NEED TO UPDATE FOR TENANT: ' ||V_TENANT_ID);
        ELSE
