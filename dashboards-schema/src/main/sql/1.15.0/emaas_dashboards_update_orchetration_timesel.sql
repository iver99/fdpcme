...
BEGIN
	...
	LOOP
     ...
     END IF;
	   ...
	   IF v_count > 0 THEN
        V_EXTENDED_OPTIONS:='{"timeSel":{"defaultValue":"last1day"},"timePeriodNotShow":["LATEST","LAST_14_DAY","LAST_30_DAY","LAST_90_DAY","LAST_1_YEAR"]}';
        UPDATE EMS_DASHBOARD SET EXTENDED_OPTIONS = V_EXTENDED_OPTIONS, ENABLE_TIME_RANGE = 2, ENABLE_ENTITY_FILTER = 2
