...
//		Assert.assertEquals(driver.getWebDriver().findElement(By.xpath(DashBoardPageId.FlexLinkID)).getText(),"AWR");
	...
	public static String getTextByID(String id)
	{
		...
		driver.click(DashBoardPageId.stopshare_btn);
           ...
           public static void dashboardDuplicate() throws Exception
		 {
	         	driver.click(DashBoardPageId.option);
		        driver.click(DashBoardPageId.Duplicatedashboard);
         						
                }                   
 
         public static void inputDuplicateDashBoardInfo(String dbName,String dbDesc) throws Exception
		{		
		driver.click(DashBoardPageId.DuplicateDashboardpopup);	
		driver.sendKeys(DashBoardPageId.DuplicateDashBoardName, dbName);
		driver.sendKeys(DashBoardPageId.DuplicateDashBoardDesc, dbDesc);
		driver.click(DashBoardPageId.savebtn);
		}    	
}
