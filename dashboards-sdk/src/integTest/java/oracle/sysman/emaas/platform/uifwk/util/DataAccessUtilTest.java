...
public class DataAccessUtilTest
{
			...
			@Mocked final RestClient anyRestClient)
	{
		...
		String res = DataAccessUtil.getRegistrationData("tenant", "user", "referrer", "sessionExp");
		Assert.assertEquals(res, reg);
	}

	@Test(groups = { "s2" })
	public void testGetRegistrationDataNullLink(@Mocked final CacheManagers anyCacheManagers,
			...
			@Mocked final RegistryLookupUtil anyRegistryLookupUtil) throws ExecutionException
	{
		...
		String res = DataAccessUtil.getRegistrationData("tenant", "user", null, null);
		Assert.assertNull(res);
	}

	@Test(groups = { "s2" })
	public void testGetTenantSubscribedApps(@Mocked final RegistryLookupUtil anyRegistryLookupUtil, @Mocked final VersionedLink anyLink,
			@Mocked final RestClient anyRestClient)
	{
	...
	public void testGetUserTenantInfo(@Mocked final CacheManagers anyCacheManagers, @Mocked final ICacheManager anyCacheManager,
			@Mocked final ICache anyCache, @Mocked final RegistryLookupUtil anyRegistryLookupUtil, @Mocked final VersionedLink anyLink,
			@Mocked final RestClient anyRestClient) throws ExecutionException
	{
		...
		String ui = DataAccessUtil.getUserTenantInfo("tenant", "user", "referer", "sessionExp");
	...
	public void testGetUserTenantInfoNullLink(@Mocked final RegistryLookupUtil anyRegistryLookupUtil)
	{
		...
		String ui = DataAccessUtil.getUserTenantInfo("tenant", "uresultser", null, null);
