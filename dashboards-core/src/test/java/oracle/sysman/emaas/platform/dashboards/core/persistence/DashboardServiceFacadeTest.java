...
//	}
	...
	public void setUp() throws Exception {
        ...
        a = newLastAccess(d.getDashboardId());
	...
	public void tearDown() throws Exception {
		if (a != null) dashboardServiceFacade.removeEmsDashboardLastAccess(a);
        if (f != null) dashboardServiceFacade.removeEmsDashboardFavorite(f);
        if (d != null) dashboardServiceFacade.removeEmsDashboard(d);
        dashboardServiceFacade.commitTransaction();
	}
	...
	/**
	 * Test method for {@link oracle.sysman.emaas.platform.dashboards.core.persistence.DashboardServiceFacade#queryByRange(java.lang.String, java.lang.Class, java.util.Map, int, int)}.
	 */
	public void testQueryByRange() {
        ...
        for (EmsDashboard emsdashboard : (List<EmsDashboard>) dqr) {
            assertEmsDashboard(emsdashboard);
        }
	}

	/**
	 * Test method for {@link oracle.sysman.emaas.platform.dashboards.core.persistence.DashboardServiceFacade#getEmsDashboardTileFindAll()}.
	 */
	public void testGetEmsDashboardTileFindAll() {
	   for (EmsDashboardTile emsdashboardtile :
            (List<EmsDashboardTile>) dashboardServiceFacade.getEmsDashboardTileFindAll()) {
           assertEmsDashboardTile(emsdashboardtile);
       }
	}

	/**
	 * Test method for {@link oracle.sysman.emaas.platform.dashboards.core.persistence.DashboardServiceFacade#mergeEmsDashboard(oracle.sysman.emaas.platform.dashboards.entity.EmsDashboard)}.
	 */
	...
	/**
	 * Test method for {@link oracle.sysman.emaas.platform.dashboards.core.persistence.DashboardServiceFacade#getEmsDashboardById(java.lang.Long)}.
	 */
	public void testGetEmsDashboardById() {
		EmsDashboard rd = dashboardServiceFacade.getEmsDashboardById(d.getDashboardId());
        assertEmsDashboard(rd);
	}

	/**
	 * Test method for {@link oracle.sysman.emaas.platform.dashboards.core.persistence.DashboardServiceFacade#getEmsDashboardFindAll()}.
	 */
	public void testGetEmsDashboardFindAll() {
		for (EmsDashboard emsdashboard : (List<EmsDashboard>) dashboardServiceFacade.getEmsDashboardFindAll()) {
            assertEmsDashboard(emsdashboard);
        }
	}

	/**
	 * Test method for {@link oracle.sysman.emaas.platform.dashboards.core.persistence.DashboardServiceFacade#getEmsDashboardLastAccessFindAll()}.
	 */
	public void testGetEmsDashboardLastAccessFindAll() {
	   for (EmsDashboardLastAccess emsdashboardlastaccess :
            (List<EmsDashboardLastAccess>) dashboardServiceFacade.getEmsDashboardLastAccessFindAll()) {
           assertEmsDashboardLastAccess(emsdashboardlastaccess);
       }
	}

	/**
	 * Test method for {@link oracle.sysman.emaas.platform.dashboards.core.persistence.DashboardServiceFacade#getEmsDashboardTileParamsFindAll()}.
	 */
	public void testGetEmsDashboardTileParamsFindAll() {
	   for (EmsDashboardTileParams emsdashboardtileparams :
           (List<EmsDashboardTileParams>) dashboardServiceFacade.getEmsDashboardTileParamsFindAll()) {
          assertEmsDashboardTileParams(emsdashboardtileparams);
      }
	}

	/**
	 * Test method for {@link oracle.sysman.emaas.platform.dashboards.core.persistence.DashboardServiceFacade#getEmsDashboardFavoriteFindAll()}.
	 */
	public void testGetEmsDashboardFavoriteFindAll() {
		for (EmsDashboardFavorite emsdashboardfavorite :
            (List<EmsDashboardFavorite>) dashboardServiceFacade.getEmsDashboardFavoriteFindAll()) {
           assertEmsDashboardFavorite(emsdashboardfavorite);
       }
	}
