...
public class LoginAndLogout {
	...
	public void login(String testName, String rel) {
		...
		try {
			tenantID = oracle.sysman.emsaas.login.utils.Utils
		...
		try {
			username = oracle.sysman.emsaas.login.utils.Utils
					.getProperty("SSO_USERNAME");
	...
	public void login(String testName, String username, String password,
			String tenantId, String rel, String servicename) {
		...
		webd.getLogger()
				.info("url is " + url + "   properties file is "
						+ testPropertiesFile);
		// String url =
