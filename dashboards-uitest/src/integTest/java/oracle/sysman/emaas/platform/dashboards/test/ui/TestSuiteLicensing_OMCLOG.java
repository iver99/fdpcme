...
public class TestSuiteLicensing_OMCLOG extends LoginAndLogout
{
	...
	@Test(alwaysRun = true)
	public void verifyEnterpriseHealth_WithFilter_GridView_OMCLOG()
	{
		//initTest
		initTest(Thread.currentThread().getStackTrace()[1].getMethodName(), tenant_username, tenant_OMC_Log);
	...
	@Test(alwaysRun = true)
	public void verifyEnterpriseHealth_WithFilter_ListView_OMCLOG()
	{
		//initTest
		initTest(Thread.currentThread().getStackTrace()[1].getMethodName(), tenant_username, tenant_OMC_Log);
	...
	@Test(alwaysRun = true)
	public void verifyExadataHealth_WithFilter_GridView_OMCLOG()
	{
		//initTest
		initTest(Thread.currentThread().getStackTrace()[1].getMethodName(), tenant_username, tenant_OMC_Log);
	...
	@Test(alwaysRun = true)
	public void verifyExadataHealth_WithFilter_ListView_OMCLOG()
	{
		//initTest
		initTest(Thread.currentThread().getStackTrace()[1].getMethodName(), tenant_username, tenant_OMC_Log);
	...
	@Test(alwaysRun = true)
	public void verifyUIGallery_WithFilter_GridView_OMCLOG()
	{
		//initTest
		initTest(Thread.currentThread().getStackTrace()[1].getMethodName(), tenant_username, tenant_OMC_Log);
	...
	@Test(alwaysRun = true)
	public void verifyUIGallery_WithFilter_ListView_OMCLOG()
	{
		//initTest
		initTest(Thread.currentThread().getStackTrace()[1].getMethodName(), tenant_username, tenant_OMC_Log);
