...
public class DashBoardUtils
{
	...
	public static void loadWebDriver(WebDriver webDriver) throws Exception
	{
		...
		if (doesWebElementExist(DashBoardPageId.OverviewCloseID))
			closeOverviewPage();
	...
	public static void searchDashBoard(WebDriver wdriver, String board) throws Exception
	{
		...
		wdriver.sendKeys(DashBoardPageId.SearchDSBoxID,
				"InvalidLongNameInvalidLongNameInvalidLongNameInvalidLongNameInvalidLongName");//clear all dashboards
		Assert.assertEquals("InvalidLongNameInvalidLongNameInvalidLongNameInvalidLongNameInvalidLongName",
				wdriver.getElement(DashBoardPageId.SearchDSBoxID).getAttribute("value"));
