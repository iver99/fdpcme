...
public class TestSuiteLicensing_SECSE extends LoginAndLogout
{
	...
	@Test(alwaysRun = true)
	public void verifyEnterpriseHealth_WithFilter_GridView_SECSE()
	{
		//initTest
		initTest(Thread.currentThread().getStackTrace()[1].getMethodName(), tenant_username, tenant_SECSE);
	...
	@Test(alwaysRun = true)
	public void verifyEnterpriseHealth_WithFilter_ListView_SECSE()
	{
		//initTest
		initTest(Thread.currentThread().getStackTrace()[1].getMethodName(), tenant_username, tenant_SECSE);
	...
	@Test(alwaysRun = true)
	public void verifyExadataHealth_WithFilter_GridView_SECSE()
	{
		//initTest
		initTest(Thread.currentThread().getStackTrace()[1].getMethodName(), tenant_username, tenant_SECSE);
	...
	@Test(alwaysRun = true)
	public void verifyExadataHealth_WithFilter_ListView_SECSE()
	{
		//initTest
		initTest(Thread.currentThread().getStackTrace()[1].getMethodName(), tenant_username, tenant_SECSE);
	...
	@Test(alwaysRun = true)
	public void verifyUIGallery_WithFilter_GridView_SECSE()
	{
		//initTest
		initTest(Thread.currentThread().getStackTrace()[1].getMethodName(), tenant_username, tenant_SECSE);
	...
	@Test(alwaysRun = true)
	public void verifyUIGallery_WithFilter_ListView_SECSE()
	{
		//initTest
		initTest(Thread.currentThread().getStackTrace()[1].getMethodName(), tenant_username, tenant_SECSE);
