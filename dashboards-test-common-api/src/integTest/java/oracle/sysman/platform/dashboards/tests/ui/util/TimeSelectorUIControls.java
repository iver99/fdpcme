...
public class TimeSelectorUIControls
{
	...
	//Begin: Button
	public static final String sApplyBtn = "button[id^='applyButton_']";
	public static final String sCancelBtn = "button[id^='cancelButton_']";
	...
	//Begin: Icon
	public static final String sStartTimeSelectIcon = "div[id^='divStartTime_'] .oj-inputdatetime-time-only .oj-inputdatetime-input-container .oj-inputdatetime-input-trigger .oj-inputdatetime-time-icon";//"/html/body/div[1]/div/div/div[1]/div/div[2]/div[1]/div/div[2]/div/div/span/span";
	public static final String sEndTimeSelectIcon = "div[id^='divEndTime_'] .oj-inputdatetime-time-only .oj-inputdatetime-input-container .oj-inputdatetime-input-trigger .oj-inputdatetime-time-icon";//"/html/body/div[1]/div/div/div[1]/div/div[2]/div[1]/div/div[5]/div/div/span/span";
	//End: Icon
