...
public class PreferenceAPITest {
    ...
    @Test
    public void testDeleteAllPreferenceByKey() throws Exception {
    ...
    @Test
    public void testDeletePreferenceByKey() throws Exception {
        //Test 403, with invalid tenantIdParam DashboardException exception;
    ...
    @Test
    public void testQueryPreferenceByKey() throws Exception {
        //Test 403, with invalid tenantIdParam DashboardException exception;
    ...
    @Test
    public void testQueryPreferences() throws Exception {
        //Test 403, with invalid tenantIdParam DashboardException exception;
    ...
    @Test
    public void testUpdatePreference1() throws Exception {
        new MockUp<APIBase>() {
            @Mock
