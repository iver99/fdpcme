...
public class ScreenshorCRUD
{
	...
	public void screenshot_query()
	{
		try {
			...
			String jsonString = "{ \"name\":\"Test_Dashboard_ScreenShot1\", \"screenShot\": \"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAABYwAAAJACAYAAA\"}";
	...
	public void screenshot_query_invalidId()
	{
		try {
			...
			//		.when().delete("/dashboards/0/screenshot");
