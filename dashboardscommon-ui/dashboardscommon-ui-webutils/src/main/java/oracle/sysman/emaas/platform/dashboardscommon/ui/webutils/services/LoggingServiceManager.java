...
import oracle.sysman.emaas.platform.dashboardscommon.ui.webutils.wls.management.AppLoggingManageMXBean;
...
/**
 * By default we log entries to /var/opt/ORCLemaas/logs/dashboardsService/dashboardsCommonUiService.log
 *
 * @author aduan
 */
public class LoggingServiceManager implements ApplicationServiceManager
{
	...
	public static final String MBEAN_NAME = "oracle.sysman.emaas.platform.dashboardscommonuiservice.logging.beans:type=AppLoggingManageMXBean";
	public static final String MBEAN_NAME_TMP = "oracle.sysman.emaas.platform.dashboardscommonuiservice.logging.beans:type=AppLoggingManageMXBean"
	...
	{
		return "Dashboard Common UI Service API Logging Service";
	}
	...
	{
		URL url = LoggingServiceManager.class.getResource("/log4j2_dsbcommui.xml");
