...
package oracle.sysman.emaas.platform.dashboardscommon.ui.webutils.wls.lifecycle;
...
{
	public static final String APPLICATION_LOGGER_SUBSYSTEM = "oracle.sysman.emaas.platform.dashboardscommon.ui";
	...
	{
		logger.notice("Post-starting registered Dashboard Framework Common UI services");
		try {
	...
	{
		logger.notice("Post-stopping registered Dashboard Framework Common UI services");
		try {
	...
	{
		logger.debug("Pre-starting registered Dashboard Framework Common UI services");
		try {
	...
	{
		logger.debug("Pre-stopping registered Dashboard Framework Common UI services");
		try {
